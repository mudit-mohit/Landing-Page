          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-8 relative">
              ...
              <p className="font-sans text-base leading-relaxed text-white/80">
                <strong className="font-semibold text-white">Book a focused strategy session with a Gautam & Instantly expert</strong> to see if automated outbound fits your business.
                <br/><br/>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <a href="#hero" className="font-sans text-sm text-white/70 hover:text-white transition-colors">Home</a>
              ...
              <div className="flex flex-col gap-4">
                ...
                <a href="https://www.linkedin.com/in/gautam-singh-manral/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group">
                  <LinkedInIcon />
              ...
              <div className="flex flex-col gap-4">
                ...
                <a href="mailto:team@outmate.co" className="flex items-center gap-2 group">
                  <MailIcon />
                  <span className="font-sans text-sm text-white/70 group-hover:text-white transition-colors">team@outmate.co</span>
                </a>
              </div>
            </div>

            {/* GTM Playbooks & Copyright */}
            <div className="flex flex-col justify-between items-start md:items-end gap-8">
              <div className="bg-white/5 border border-white/10 p-6 rounded-xl max-w-sm">
                <h3 className="font-display font-semibold text-2xl text-white">Check out some of our GTM playbooks here</h3>
                <a 
                  href="#" 
                  className="inline-block mt-4 bg-white text-black px-4 py-2 rounded-lg font-display font-medium text-sm"
                >
                  Check out
                </a>
              </div>
